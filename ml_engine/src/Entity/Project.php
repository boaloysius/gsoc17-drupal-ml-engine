 ...
 *   label = @Translation("ML Engine Project entity"),
 *   handlers = {
 *     "view_builder" = "Drupal\Core\Entity\EntityViewBuilder",
 *     "list_builder" = "Drupal\ml_engine\Entity\Controller\ProjectListBuilder",
 *     "form" = {
 *       "add" = "Drupal\ml_engine\Form\ProjectForm",
 *       "edit" = "Drupal\ml_engine\Form\ProjectForm",
 *       "delete" = "Drupal\ml_engine\Form\ProjectDeleteForm",
 *     },
 *     "access" = "Drupal\ml_engine\ProjectAccessControlHandler",
 *   },
 *   base_table = "ml_engine",
 *   admin_permission = "administer ml_engine_project entity",
 *   entity_keys = {
 *     "id" = "id",
 *     "label" = "name",
 *     "uuid" = "uuid"
 ...
 *     "edit-form" = "/ml_engine/{ml_engine_project}/edit",
 *     "delete-form" = "/ml_engine/{ml_engine_project}/delete",
 *     "collection" = "/ml_engine/list"
 *   },
 *   fieldable = TRUE,
 * )
 */
